package com.example.woodWolf.client.model;
...
@OnlyIn(Dist.CLIENT)
public class WolfModel<T extends BaseWolfEntity> extends TintedAgeableModel<T> {
	...
	protected Iterable<ModelRenderer> getBodyParts() {
		return ImmutableList.of(this.head, this.body, this.legBackRight, this.legBackLeft, this.legFrontRight, this.legFrontLeft, this.tail, this.mane);
	}

	public void setLivingAnimations(T entityIn, float limbSwing, float limbSwingAmount, float partialTick) {
		/*if(entityIn.world.isNightTime()) {
			entityIn.setSitting(true);
